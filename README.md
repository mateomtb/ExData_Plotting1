...
<b>Do not commit the huge txt file to your repo! You will be in hell. Here is how you clean it up</b>
```git filter-branch -f --tree-filter 'rm -rf household_power_consumption.txt' HEAD```
